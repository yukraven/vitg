...
class TestInit(unittest.TestCase):
    def testSuccess(self):
        dictionary = {"name": "1", "startDescription": "2", "description": "3", "speed": 4, "actions": ["5"]}
    ...
    def testWrongData(self):
        dictionaries = [{"name": 1, "startDescription": "2", "description": "3", "speed": 4, "actions": ["5"]},
                        ...
                        {"startDescription": "2", "description": "3", "speed": 4, "actions": ["5"]},
                        {"name": "1", "description": "3", "speed": 4, "actions": ["5"]},
                        {"name": "1", "startDescription": "2", "speed": 4, "actions": ["5"]},
                        {"name": "1", "startDescription": "2", "description": "3", "actions": ["5"]},
                        {"name": "1", "startDescription": "2", "description": "3", "speed": 4}]
        errors = ["name", "startDescription", "description", "speed", "actions",
